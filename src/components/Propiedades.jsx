...
function Propiedades() {
  ...
  const handleDeleteClick = (propiedad) => {
  ...
  const propiedades = [
    { id: 1, name: 'Dreams Sapphire', color: 'bg-purple-200' },
    { id: 2, name: 'Dreams Riviera', color: 'bg-green-200' },
    { id: 3, name: 'Dreams Sands Cancún', color: 'bg-pink-200' }
  ]
  ...
  return (
    <div className="p-8">
      ...
      <div className="flex mb-4 px-4">
        <div className="flex-1 text-sm font-semibold text-gray-700">Nombre de la propiedad</div>
      ...
      <div className="space-y-4">
        {propiedades.map((propiedad) => (
          <div key={propiedad.id} className="bg-white rounded-2xl shadow-md p-6 flex items-center justify-between">
            {/* Name Column */}
            <div>
              <span className={`${propiedad.color} px-6 py-2 rounded-full text-sm text-gray-800`}>
                {propiedad.name}
              </span>
            </div>
            ...
            <div className="flex gap-3">
              ...
              <button 
                className="text-gray-400 hover:text-gray-600"
                onClick={() => handleDeleteClick(propiedad)}
              >
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {showDeleteModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-8 max-w-md w-full mx-4">
            <h2 className="text-2xl font-semibold mb-6">Eliminar propiedad</h2>
            <p className="text-gray-700 mb-8">
              ¿Estas seguro que deseas eliminar esta propiedad?
            </p>
      ...
      {showEditModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-8 max-w-md w-full mx-4">
            <h2 className="text-2xl font-semibold mb-6">Editar propiedad</h2>
            <div className="mb-8">
      ...
      {showAddModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-8 max-w-md w-full mx-4">
            <h2 className="text-2xl font-semibold mb-6">Registrar a una nueva propiedad</h2>
            <div className="mb-8">
              <label className="block text-gray-700 font-medium mb-2">Nombre:</label>
              <input
                type="text"
