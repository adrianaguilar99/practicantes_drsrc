...
import InternViewPage from '../pages/Interns/intern-view.page';
import InternInformationPage from '../pages/Interns/intern-information.page';
import ProfilePage from '../pages/profile/profile.page';
import ProgressViewPage from '../pages/progress/progress-view.page';
...
function RoutesConfig (){
 return (
    ...
    <Routes>
        ...
        <Route path="/intern-view" element={< InternViewPage />} />
        <Route path="/profile" element={< ProfilePage />} />
        <Route path="/progress" element={< ProgressViewPage />} />
